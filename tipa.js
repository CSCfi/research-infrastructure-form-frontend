...
function addSection(id) {
        ...
        <fieldset class="white">
                            ...
                            <fieldset>
                                ...
                                <label for="SerPointSame">
                                    <input type="checkbox" id="SerPointSame" name="SerPointSame" value="yes" onclick="toggleElement('hidden_fields2', this.checked)" />
                            ...
                            <fieldset>
                                ...
                                <label for="SerCoOrg">
                                    <input type="checkbox" id="SerCoOrg" name="SerCoOrg" value="yes" onclick="toggleElement('hidden_fields3', this.checked)"/>
                           ...
                           <fieldset id="SerCoOrgOther">
                            ...
                            <fieldset>
                                ...
                                <label for="SerPointOther_add">
                                    <input type="checkbox" id="SerPointOther_add" name="SerPointOther_add" value="yes" onclick="toggleElement('hidden_fields4', this.checked)"/>
  ...
  function removeSection(id) {
    ...
    <div class="test">
      ...
      </fieldset> ${removedDivs}</p>
      <button class="cta-pal" onclick="removeSection('${id}')" type="button">Poista palvelu</button>
    </div>
    `;
  ...
  const newDiv = document.createElement("div");
  newDiv.innerHTML = markup;
  document.getElementById(id).removeChild(newDiv);
}
 ///testi poistonappi
